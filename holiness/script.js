/* =============================================
   script.js — 드라마틱 에필로그 : 하나님이 기뻐하시는 거룩
   레위기 19:2, 미가 6:8
   ============================================= */
...
function shareKakao() {
  ...
  try {
    Kakao.Share.sendDefault({
      objectType: 'feed',
      content: {
        title: '드라마틱 에필로그 — 하나님이 기뻐하시는 거룩',
        description: '삶으로 증명하는 진짜 거룩! 일상 속에서 구별된 삶을 살아가는 하나님의 자녀로 함께 일어납시다.',
...
// 링크 복사 fallback
// clipboard API or text area element fallback
